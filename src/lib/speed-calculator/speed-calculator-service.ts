...
import { orderPairBySpeed as orderPairBySpeedPure, type OrderPairBySpeedOptions } from "@lib/speed-calculator/order-pair-by-speed"
...
export class SpeedCalculatorService {
  ...
  orderPairBySpeed(pokemonOne: Pokemon, pokemonTwo: Pokemon, field: Field, options?: OrderPairBySpeedOptions): [Pokemon, Pokemon] {
    return orderPairBySpeedPure(pokemonOne, pokemonTwo, field, options)
  }
