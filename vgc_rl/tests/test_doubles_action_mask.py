...
def test_kings_shield_requires_self_target() -> None:
    party_a = [
        {
            "name": "Kingambit",
            "moves": [{"name": "Earthquake"}, {"name": "King's Shield"}, {"name": "Tackle"}, {"name": "Tackle"}],
            "hpPercentage": 100.0,
            "activeMovePosition": 1,
        },
        _mon(name="A1"),
...
def test_swords_dance_requires_self_target() -> None:
    party_a = [
        {
            "name": "Garchomp",
            "moves": [{"name": "Dragon Claw"}, {"name": "Swords Dance"}, {"name": "Tackle"}, {"name": "Tackle"}],
            "hpPercentage": 100.0,
            "activeMovePosition": 1,
        },
        _mon(name="A1"),
